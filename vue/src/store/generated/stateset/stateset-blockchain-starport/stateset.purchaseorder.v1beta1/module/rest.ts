...
type.
*/
export type V1Beta1MsgFinancePurchaseOrderResponse = object;

/**
* MsgFinancePurchaseOrderResponse is the Msg/FinancePurchaseOrder response
type.
*/
export type V1Beta1MsgLockPurchaseOrderResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryPurchaseOrders = (
    ...
    this.request<V1Beta1QueryPurchaseOrdersResponse, RpcStatus>({
      path: `/stateset/purchaseorder/v1beta1/purchaseorders`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryPurchaseOrder = (purchaseorderId: string, params: RequestParams = {}) =>
    this.request<V1Beta1QueryPurchaseOrderResponse, RpcStatus>({
      path: `/stateset/purchaseorder/v1beta1/purchaseorders/${purchaseorderId}`,
      method: "GET",
      format: "json",
      ...params,
    });
