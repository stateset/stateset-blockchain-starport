 ...
 */
export type V1Beta1MsgCancelInvoiceResponse = object;

/**
 * MsgSignDataResponse is the Msg/SignData response type.
 */
export type V1Beta1MsgCompleteInvoiceResponse = object;
 ...
 * MsgSignDataResponse is the Msg/SignData response type.
 */
export type V1Beta1MsgDeleteInvoiceResponse = object;

export type V1Beta1MsgFactorInvoiceResponse = object;
 ...
 */
export interface V1Beta1QueryGetInvoiceResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryInvoice = (invoiceId: string, params: RequestParams = {}) =>
    this.request<V1Beta1QueryGetInvoiceResponse, RpcStatus>({
      path: `/stateset/invoice/v1beta1/invoices/${invoiceId}`,
      method: "GET",
      format: "json",
      ...params,
    });
