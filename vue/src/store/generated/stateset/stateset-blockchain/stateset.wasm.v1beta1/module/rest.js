...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryCodeInfo = (codeId, params = {}) => this.request({
         ...
         */
        this.queryByteCode = (codeId, params = {}) => this.request({
         ...
         */
        this.queryContractStore = (contractAddress, query, params = {}) => this.request({
         ...
         */
        this.queryRawStore = (contractAddress, query, params = {}) => this.request({
         ...
         */
        this.queryContractInfo = (contractAddress, params = {}) => this.request({
